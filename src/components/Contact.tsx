        ...
        >
          ...
          <div className="space-y-4 text-sm" style={{ color: '#94a3b8' }}>
            <div className="flex items-center gap-3">
              ...
              <a href="tel:+917869729829" className="hover:text-white transition-colors cursor-pointer">+91 78697 29829</a>
            </div>
            <div className="flex items-center gap-3">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
              </svg>
              <a href="mailto:support@cherubim.in" className="hover:text-white transition-colors cursor-pointer">support@cherubim.in</a>
            </div>
            <div className="flex items-center gap-3">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
